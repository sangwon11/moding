...
import { createFundingValidator, validateError } from "../../middleware/validator";
...
sellerRouter.post("/delivery/:fundingId", asyncHandler(sellerController.deliveryUpdate));

...
export const ContentsWrap = tw.div`bg-[#D9D9D9]/[.1] p-8 w-[720px] text-center rounded-3xl`
...
export const SupPriceWrap = tw.div`flex justify-between p-4 border-b border-[#D9D9D9]/[0.2] text-right`
export const SupPrice = tw.p``
export const DeliveryPriceWrap =tw.div`flex justify-between p-4 border-b border-[#D9D9D9]/[0.2] text-right`
...
export const NextBtn = tw.button`text-xl bg-blue-500 font-bold h-[56px] w-[400px] rounded-3xl disabled:bg-gray-300`

export const MeWrap = tw.div`flex flex-col py-6 border-y border-[#D9D9D9]/[0.2]`
export const MeLabel = tw.label`text-xl font-bold text-gray-300 text-left py-3`

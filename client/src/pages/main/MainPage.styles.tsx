...
export const ContentArea = tw.div`
  relative mt-10 flex justify-between items-start
`
// 섹션
...
export const StickySection = tw.div`
   sticky top-10 w-1/4 mr-4 p-4 space-y-3 rounded bg-[#D9D9D9]/[.1] mt-[72.5px] mb-4
`
// 실시간 랭킹 타이틀
...
export const EarlyBirdTitle = tw.h2`
  ...
  text-4xl font-bold text-center my-4 text-white
`

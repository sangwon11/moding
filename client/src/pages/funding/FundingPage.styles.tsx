...
export const NavOnBtn = tw.button`w-[200px] h-[52px]`;
...
export const MainImgWrap = tw.div`w-[700px] h-[450px] overflow-hidden rounded-2xl mb-10`
export const MainImg = tw.img` h-full w-full object-cover`
export const MainInfoLabel = tw.p`text-2xl font-bold my-4 mr-auto text-gray-300`
export const MainInfoWrap = tw.div`w-[680px] py-6 my-12 bg-white rounded-2xl text-black flex flex-col items-center px-10`
export const RefundWrap = tw.div`mt-10 px-16 bg-[#D9D9D9]/[.1] h-auto py-12 text-white text-base rounded-[24px] flex flex-col justify-center`
export const RefundLabel = tw.p`text-lg font-bold py-4`
export const RefundText = tw.p`text-xs py-1`

export const FloatingWrap = tw.div`w-[39%] h-auto flex flex-col`
export const FloatingSticky = tw.div`sticky top-4`
...
export const FundingTitle = tw.p`text-2xl font-bold`
export const FundingInfo = tw.p`text-base py-3`
export const FundingDate = tw.p`text-base`
...
export const OptionsWrap = tw.div`mt-3 bg-[#D9D9D9]/[.1] p-8 rounded-3xl`
...
export const OptTitle = tw.span`text-lg font-bold`

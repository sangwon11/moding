...
export const MainImgWrap = tw.div`w-[700px] h-[450px] overflow-hidden rounded-2xl`
export const MainImg = tw.img` h-full w-full object-cover`
export const MainInfoLabel = tw.p`text-2xl font-bold mt-16 mr-auto px-6 text-gray-300`
export const MainInfoWrap = tw.div`w-[700px] py-6 my-12 bg-white rounded-2xl text-black`
export const RefundWrap = tw.div`px-10 bg-[#D9D9D9]/[.1] h-auto py-12 text-white text-base rounded-tl-[0px] flex flex-col justify-center`
export const RefundLabel = tw.p``
export const RefundText = tw.p``
